...
func TestManagedKeyStore_CreateAndLookup(t *testing.T) {
	...
	result, err := mks.Create("client-a", "required")
	if err != nil {
		t.Fatal(err)
	}
	if result.Key == "" {
...
func TestManagedKeyStore_CreateDuplicate(t *testing.T) {
	...
	if _, err := mks.Create("client-a", ""); err != nil {
		t.Fatal(err)
	}
	if _, err := mks.Create("client-a", ""); err == nil {
...
func TestManagedKeyStore_List(t *testing.T) {
	...
	if _, err := mks.Create("alpha", "auto"); err != nil {
		t.Fatal(err)
	}
	if _, err := mks.Create("beta", "required"); err != nil {
		t.Fatal(err)
	}
...
func TestManagedKeyStore_UpdateEnabled(t *testing.T) {
	...
	result, err := mks.Create("client-a", "")
	if err != nil {
		t.Fatal(err)
	}
	rawKey := result.Key
...
func TestManagedKeyStore_PersistenceAcrossReloads(t *testing.T) {
	...
	result, err := mks1.Create("persistent-client", "auto")
	if err != nil {
		t.Fatal(err)
	}
	rawKey := result.Key
...
func TestManagedKeyStore_Counters(t *testing.T) {
	...
	if _, err := mks.Create("a", ""); err != nil {
		t.Fatal(err)
	}
	if _, err := mks.Create("b", ""); err != nil {
		t.Fatal(err)
	}
