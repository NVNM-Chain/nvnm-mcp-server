...
func testPool(t *testing.T) *pgxpool.Pool {
	...
	if _, err := pool.Exec(context.Background(),
		"TRUNCATE api_keys, write_audit, signer_quota, signer_blacklist, admin_audit; DROP TABLE goose_db_version"); err != nil {
		t.Fatalf("truncate api_keys/write_audit/signer_quota/signer_blacklist/admin_audit, drop goose_db_version: %v", err)
	}
