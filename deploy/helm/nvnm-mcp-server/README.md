...
Deploys the [NVNM Chain MCP Server](https://github.com/NVNM-Chain/nvnm-mcp-server) on Kubernetes. Hand-curated; matches `Chart.yaml` version `0.2.6` (appVersion `1.0.0-rc9`).
